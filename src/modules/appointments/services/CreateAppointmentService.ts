...
class CreateAppoitmentService {
  ...
  public async execute({
    ...
    if (findAppoimentInSameDate) {
      throw new AppError('This appointment is aleread booked.');
    }
    ...
    const dateFormatend = format(appointmentDate, "dd/MM/yyyy 'às' HH:mm'h'");

    await this.notificationRepository.create({
      recipient_id: provider_id,
      content: `Novo agendamento para dia ${dateFormatend} `,
    });
